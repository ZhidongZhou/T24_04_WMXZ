...
<div class="sln-box sln-box--main">
    ...
    <div class="sln-box--sub row">
        <div class="col-xs-12">
            <h2 class="sln-box-title"><?php _e('Enable feedback submission request','salon-booking-system') ?></h2>
            <p><?php _e('If enabled an email/sms will be sent automatically to the customer one day after the last visit to the salon.', 'salon-booking-system') ?></p>
        </div>
        <div class="col-xs-12">
            <div class="row">
                <div class="col-xs-6 col-sm-3 col-md-3 form-group sln-checkbox">
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6">
		...
		<?php _e('Administration rule','salon-booking-system') ?>
	    </h2>
            <div class="row">
                <div class="col-xs-12 form-group sln-checkbox">
