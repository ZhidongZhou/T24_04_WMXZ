...
function delight_spa_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 1', 'delight-spa' ),
		'description'   => __( 'Appears on footer', 'delight-spa' ),
		'id'            => 'footer-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 2', 'delight-spa' ),
		'description'   => __( 'Appears on footer', 'delight-spa' ),
		'id'            => 'footer-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 3', 'delight-spa' ),
		'description'   => __( 'Appears on footer', 'delight-spa' ),
		'id'            => 'footer-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function delight_spa_scripts() {
	wp_enqueue_style( 'delight-spa-font', delight_spa_font_url(), array() );	
	wp_enqueue_style( 'bootstrap', get_template_directory_uri().'/css/bootstrap.css' );
	wp_enqueue_style( 'delight-spa-basic-style', get_stylesheet_uri() );
	wp_enqueue_style( 'nivo', get_template_directory_uri().'/css/nivo-slider.css' );
	...
	wp_enqueue_script( 'jquery.superfish', get_template_directory_uri() . '/js/jquery.superfish.js', array('jquery') );	
