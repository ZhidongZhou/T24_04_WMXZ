	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'i-design' ),
				'remove'               => esc_html__( 'Remove', 'i-design' ),
				'default'              => esc_html__( 'Default', 'i-design' ),
				'selectFile'           => esc_html__( 'Select File', 'i-design' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'i-design' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'i-design' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'i-design' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'i-design' ),
			)
		);
