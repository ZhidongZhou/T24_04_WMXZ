...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'i-design' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'i-design' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'i-design' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'i-design' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'i-design' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'i-design' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'i-design' ); ?>',
} );
#>
