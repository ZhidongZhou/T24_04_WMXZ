...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'i-design' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'i-design' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'i-design' ),
			'200'       => esc_html__( 'Light 200', 'i-design' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'i-design' ),
			'300'       => esc_html__( 'Book 300', 'i-design' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'i-design' ),
			'400'       => esc_html__( 'Normal 400', 'i-design' ),
			'regular'   => esc_html__( 'Normal 400', 'i-design' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'i-design' ),
			'500'       => esc_html__( 'Medium 500', 'i-design' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'i-design' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'i-design' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'i-design' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'i-design' ),
			'700'       => esc_html__( 'Bold 700', 'i-design' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'i-design' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'i-design' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'i-design' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'i-design' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'i-design' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'i-design' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'i-design' ),
		);
	}
