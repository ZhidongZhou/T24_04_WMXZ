...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'i-design' ),
				'change'       => esc_html__( 'Change image', 'i-design' ),
				'default'      => esc_html__( 'Default', 'i-design' ),
				'remove'       => esc_html__( 'Remove', 'i-design' ),
				'placeholder'  => esc_html__( 'No image selected', 'i-design' ),
				'frame_title'  => esc_html__( 'Select image', 'i-design' ),
				'frame_button' => esc_html__( 'Choose image', 'i-design' ),
			)
		);
	}
