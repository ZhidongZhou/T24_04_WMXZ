...
<body <?php body_class(); ?> style="">
	...
	<div id="page" class="hfeed site">
            ...
            <header id="masthead" class="site-header" role="banner">
         		<div class="headerinnerwrap">
                    ...
                    <div id="navbar" class="navbar">
                        ...
                        <?php
                        global $woocommerce;
						$show_cart = get_theme_mod('show_cart', 1);
		...
		$idesign_pbpage = 0;
		if ( is_page_template( 'page_bbuilder.php' ) || is_page_template( 'page_brizy.php' ) || is_page_template( 'page_elementor.php' ) ) {
			$idesign_pbpage = 1;
		}
        ...
        <?php 
		elseif( $header_type != '0' && $idesign_pbpage == 0 ) : 
		?>
