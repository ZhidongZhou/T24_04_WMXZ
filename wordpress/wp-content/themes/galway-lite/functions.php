...
{   
    wp_enqueue_style('galway-lite-admin-style', get_template_directory_uri() . '/assets/twp/css/admin.css', array(), '1.0.0');
    if ('widgets.php' === $hook) {
        wp_enqueue_media();
        wp_enqueue_script('galway-lite-widgets', get_template_directory_uri() . '/assets/twp/js/widgets.js', array('jquery'), '1.0.0', true);
    }
    wp_enqueue_script('galway-lite-admin', get_template_directory_uri() . '/assets/twp/js/admin.js', array('jquery'), '1.0.0', true);

    $ajax_nonce = wp_create_nonce('galway_lite_ajax_nonce');
            
    wp_localize_script( 
        'galway-lite-admin', 
        'galway_lite_admin_script_data',
        array(
            'ajax_url'   => esc_url( admin_url( 'admin-ajax.php' ) ),
            'ajax_nonce' => $ajax_nonce,
            'active' => esc_html__('Active','galway-lite'),
            'deactivate' => esc_html__('Deactivate','galway-lite'),
         )
    );
...
require get_template_directory() . '/inc/about-classes.php';
require get_template_directory() . '/inc/admin-notice.php';
require get_template_directory() . '/inc/plugins-classes.php';